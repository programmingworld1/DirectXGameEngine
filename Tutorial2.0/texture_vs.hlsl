...
You can change the zero to any number to indicate which set of coordinates 
you are working with as multiple texture coordinates are allowed.*/
...
PixelInputType TextureVertexShader(VertexInputType input)
{
	...
	/*The only difference in the texture vertex shader in comparison to the color vertex shader 
	from the previous tutorial is that instead of taking a copy of the color from the 
	input vertex we take a copy of the texture coordinates and pass them to the pixel shader.*/
